...
```{r}
data(item_to_category) # item-category crosswalk
...
```{r}
data(category_to_sector546) # category-sector crosswalk
...
We must first convert spending by sector to the necessary Industry/Commercial format. Each destination Excel tab requires a header table and a data table: 
