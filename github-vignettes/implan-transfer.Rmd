...
It's convenient to wrap the prep/write steps into a single function for production. Note that for Implan import, you'll first need to open the `.xlsx` file and save to the legacy `.xls` format which Implan requires.
