...
Allocating spending to Implan sectors requires a spending table and 2 crosswalk tables. The implan package includes crosswalk tables to demonstrate the allocation process.
